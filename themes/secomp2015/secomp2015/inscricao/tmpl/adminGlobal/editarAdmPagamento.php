	...
	<form name="form" id="form" class="form-horizontal" method="POST" action="sistema.php?acao=adminGlobal/salvarValoresAdmPagamento" >
		<input type="hidden" name="idAdmPagamento" value="<?php echo $GLOBALS['info']['id_usuario']; ?>" />
		<div class='box'>
            <div class='box-header'>
                <i class='fa  fa-tasks'></i>
              <h3 class='box-title'>Editar Administrador de pagamento</h3>
          	</div><!-- /.box-header -->
					...
					<div class="panel-body">
						<div class="form-group">
							<div class="col-sm-offset-2	 col-sm-10 ">
								<button class="btn btn-grey1 pull-right" id="salvarAdmCredenciamento" type="submit">Salvar</button>
							</div>
						</div>
					</div>
				</div>
