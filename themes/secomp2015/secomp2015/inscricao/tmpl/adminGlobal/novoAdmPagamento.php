...
<form name="form" id="form1" class="form-horizontal" action="sistema.php?acao=adminGlobal/cadastrarAdmPagamento" method="POST">
	<div class='box'>
            <div class='box-header'>
                <i class='fa  fa-cogs'></i>
              <h3 class='box-title'>Cadastro de Administrador de Pagamento</h3>
          	</div><!-- /.box-header -->
